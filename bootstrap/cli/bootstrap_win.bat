...
echo *************************************************************
echo Welcome to the w3stringsx CLI bootstrapper
...
echo.
echo Setup complete!
echo You can now run your application by double-clicking w3stringsx.pyz or running: python w3stringsx.pyz
pause
