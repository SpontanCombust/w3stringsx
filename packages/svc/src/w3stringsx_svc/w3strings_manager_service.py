...
class W3StringsManagerService:
    def __init__(self, encoder: W3StringsEncoder) -> None: # pyright: ignore[reportGeneralTypeIssues]
        self.encoder: W3StringsEncoder = encoder # pyright: ignore[reportGeneralTypeIssues]
    ...
    def decode_w3strings_to_csv(self, input_path: str, output_dir: str):
        ...
        with ScratchFolder(os.path.dirname(input_path)) as scratch:
            ...
            csv_file = self.encoder.decode(input_copy_path)
    ...
    def encode_w3strings_from_csv(self, input_path: str, output_dir: str, target_langs: list[str], keep_processed_csv: bool):
        ...
        with ScratchFolder(os.path.dirname(input_path)) as scratch:
            ...
            try:
                w3strings_file = self.encoder.encode(output_doc_path, None)
